...
function () {
  ...
  function Global() {
    ...
    // variables
    this.tick = 0; // dom elements grouped by their job
  ...
  _createClass(Global, [{
    ...
    key: "next",
    value: function next() {
      this.tick++; // console.log(this.tick);
    ...
    value: function menu() {
      ...
      var menuDrop = document.querySelectorAll('.menu .menu-item-has-children > a'); //only first descendents

      var mobMenuDrop = document.querySelectorAll('.mobile-menu_items .menu-item-has-children'); //for mobile
...
/***/ "./src/assets/js/modules/NepaliDate.js":
/*!*********************************************!*\
  !*** ./src/assets/js/modules/NepaliDate.js ***!
  \*********************************************/
/*! exports provided: default */
...
function () {
  function NepaliDate() {
    ...
    this.date = mayur.np_date.date; // methods
  ...
  _createClass(NepaliDate, [{
    key: "convertWeekDays",
    value: function convertWeekDays() {
      switch (this.day) {
        case "Sunday":
    ...
    value: function prototype() {
      ...
      var month = this.convertMonths();
      var date = this.convertDate();
      var day = this.convertWeekDays();
...
/* harmony default export */ __webpack_exports__["default"] = (NepaliDate);
...
function () {
  function Search() {
    ...
    // variables
    this.postResults; // Elements related to search overlay

    this.btnOpenSearch = document.querySelector('.search-trigger');
    this.searchOverlay = document.querySelector('.search-overlay');
    this.btnCloseOverlay = document.querySelector('.search-overlay_close'); // Elements related to search result
  ...
  _createClass(Search, [{
    ...
    value: function events() {
      ...
      this.btnCloseOverlay.addEventListener('click', this.closeOverlay.bind(this)); // this.btnSearch.addEventListener('click', this.getResults.bind(this));
    ...
    value: function closeOverlay() {
      ...
      document.body.style.overflow = 'auto'; // console.log('closed');
    ...
    value: function keyPressDispatcher(e) {
      ...
      var isFocused = document.activeElement === inputEl || document.activeElement === textareaEl; //avoid opening on typing in input field and textarea
    ...
    value: function getResults() {
      ...
      var url = mayur.root_url + '/wp-json/mayur/v1/posts?term=' + this.searchField.value;
...
/* harmony import */ var _modules_NepaliDate__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/NepaliDate */ "./src/assets/js/modules/NepaliDate.js");
/* harmony import */ var _modules_Search__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/Search */ "./src/assets/js/modules/Search.js");
...
var nepaliDate = new _modules_NepaliDate__WEBPACK_IMPORTED_MODULE_3__["default"]();
